  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" method="post" action="{{ route('status.update',$status->id) }}">
          @csrf
          @method('PUT')
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-6">
              <textarea name="deskripsi"class="form-control" id="exampleFormControlTextarea1" rows="5">{{ $status->deskripsi }}</textarea>
            </div>
          </div>
